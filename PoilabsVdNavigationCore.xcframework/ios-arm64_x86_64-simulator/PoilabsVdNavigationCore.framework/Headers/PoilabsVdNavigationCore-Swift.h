...
@class PLPositioningModeInfo;
@class NSString;
SWIFT_ENUM_FWD_DECL(NSInteger, PLPStatus)
SWIFT_ENUM_FWD_DECL(NSInteger, PLPLocationStatusReason)
SWIFT_ENUM_FWD_DECL(NSInteger, PoilabsPositioningError)
@class CLHeading;
...
SWIFT_CLASS("_TtC23PoilabsVdNavigationCore15SessionDelegate")
...
@class NSURL;
@interface SessionDelegate (SWIFT_EXTENSION(PoilabsVdNavigationCore)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PoilabsVdNavigationCore)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PoilabsVdNavigationCore)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PoilabsVdNavigationCore)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC23PoilabsVdNavigationCore12TaskDelegate")
